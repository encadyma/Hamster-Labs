...
class RobotBehavior(object):
    ...
    def spawn_threads(self):
        ...
        sm.add_state('Discover', 'flag_border', self.stopping, 'Border')

        sm.add_state('ObstacleLeft', 'obs_left', self.turning_left, 'ObstacleLeft')
        sm.add_state('ObstacleLeft', 'obs_right', self.turning_left, 'ObstacleLeft')
        sm.add_state('ObstacleLeft', 'obs_none', self.moving_forward, 'Discover')
        sm.add_state('ObstacleLeft', 'flag_border', self.stopping, 'Border')

        sm.add_state('ObstacleRight', 'obs_left', self.turning_right, 'ObstacleRight')
        ...
        sm.add_state('ObstacleRight', 'flag_border', self.stopping, 'Border')

        sm.add_state('Border', 'flag_border', self.stopping, 'Border')

        sm.set_start_state('Discover')
        sm.add_end_state('Border')
